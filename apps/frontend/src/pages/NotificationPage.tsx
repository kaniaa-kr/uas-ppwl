        ...
        <div className="max-w-[600px] mx-auto px-4 py-4 md:py-8">
              ...
              <button
                ...
                className={`px-4 py-[6px] rounded-full text-[13px] font-semibold capitalize transition-colors ${
                  filter === f
                    ...
                    : "bg-neutral-100 dark:bg-neutral-900 text-neutral-500 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-800 hover:text-neutral-950 dark:hover:text-neutral-50"
                }`}
              >
          ...
          {loading && (
            <div className="flex justify-center items-center py-16">
              <div className="w-8 h-8 rounded-full border-2 border-neutral-200 dark:border-neutral-800 border-t-neutral-400 dark:border-t-neutral-500 animate-spin" />
            </div>
          )}
